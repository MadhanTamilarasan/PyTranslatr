...
#arrow
arrow_img = PhotoImage(file = "arrow2.png")
image_label = Label(root,image=arrow_img,width=150)
image_label.place(x=460,y=50)


#importing languages from google trans {1:'english'}
...
label1 = Label(root,text="ENGLISH", font="segoe 30 bold", bg="white",width=18,bd=5,relief=RAISED)
